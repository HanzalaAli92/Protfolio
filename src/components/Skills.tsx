    ...
    <div id='skills' className='container pt-32'>
      <div className='grid md:grid-cols-2 gap-20 items-center'>
        <div data-aos="zoom-in-up">
          <h2 className='text-4xl md:text-5xl text-cyan-700'>Technologies I work with</h2>
        ...
        <div>
          <div className=' geid-cols-2 text-cyan-700 text-3xl sm:text-4xl inline-flex space-x-20'>
